<template>
  ...
  >
    <div
      ...
      "
    >
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" class="opacity-50 absolute -left-24 -top-12 w-60 h-60">
        <path
          fill="#BAE6FF"
      ...
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" class="opacity-50 absolute -right-24 -top-18 w-52 h-52">
        <path
          fill="#A7F0BA"
      ...
      <div class="relative">
        ...
        <div class="mt-8">
          <div class="neumorph-1 bg-gray-100 p-2 rounded-lg mb-3">
            <div class="bg-white rounded-lg font-bold flex p-2">
              <div class="bg-gray-300 p-3 rounded-lg">A</div>
              <div class="flex items-center pl-6">Thor</div>
            </div>
          </div>
          <div class="neumorph-1 bg-gray-100 p-2 rounded-lg mb-3">
            <div class="bg-red-500 text-white rounded-lg font-bold flex p-2">
              <div class="bg-gray-800 p-3 rounded-lg">B</div>
              <div class="flex items-center pl-6">Doctor Strange</div>
            </div>
          </div>
          <div class="neumorph-1 bg-gray-100 p-2 rounded-lg mb-3 relative">
            <div
              class="
                absolute
                right-0
            ...
            <div class="bg-green-700 text-white rounded-lg font-bold flex p-2">
          ...
          <div class="neumorph-1 bg-gray-100 p-2 rounded-lg mb-3">
            <div class="bg-white rounded-lg font-bold flex p-2">
              <div class="bg-gray-300 p-3 rounded-lg">D</div>
